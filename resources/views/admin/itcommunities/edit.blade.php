...
@section('pageTitle', 'Modifier une formation IT')
@section('pageSubTitle', 'Formations / Édition')
...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-4xl mx-auto">
        ...
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">
            Modifier la formation : <span class="text-blue-600">{{ $itcommunity->titre }}</span>
        </h2>
        ...
        <form action="{{ route('admin.itcommunities.update', $itcommunity->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" name="titre" id="titre" required
                           value="{{ old('titre', $itcommunity->titre) }}"
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="text" name="reference" id="reference"
                           value="{{ old('reference', $itcommunity->reference) }}"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="6" required
                          ...
                          placeholder="Décrivez le contenu et les objectifs de la formation...">{{ old('description', $itcommunity->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="duree" id="duree" min="1"
                           value="{{ old('duree', $itcommunity->duree) }}"
                ...
                <div>
                    ...
                    <input type="date" name="date_debut" id="date_debut"
                           value="{{ old('date_debut', $itcommunity->date_debut ? $itcommunity->date_debut->format('Y-m-d') : '') }}"
                ...
                <div>
                    ...
                    <input type="date" name="date_fin" id="date_fin"
                           value="{{ old('date_fin', $itcommunity->date_fin ? $itcommunity->date_fin->format('Y-m-d') : '') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="lieu" id="lieu"
                           value="{{ old('lieu', $itcommunity->lieu) }}"
                ...
                <div>
                    ...
                    <input type="text" name="formateur" id="formateur"
                           value="{{ old('formateur', $itcommunity->formateur) }}"
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                <span>{{ $itcommunity->image ? 'Changer l\'image' : 'Télécharger une image' }}</span>
            ...
            <div class="flex items-center">
                ...
                <input type="checkbox" name="actif" id="actif" value="1"
                       {{ old('actif', $itcommunity->actif) ? 'checked' : '' }}
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="text-xs text-gray-600 space-y-1">
                    <p><strong>Créée le :</strong> {{ $itcommunity->created_at->format('d/m/Y à H:i') }}</p>
                    @if($itcommunity->updated_at != $itcommunity->created_at)
                        <p><strong>Dernière modification :</strong> {{ $itcommunity->updated_at->format('d/m/Y à H:i') }}</p>
                    @endif
                </div>
            </div>
            ...
            <div class="pt-5 flex justify-between">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('admin.itcommunities.show', $itcommunity->id) }}"
...
<script>
    ...
    // Initialiser la validation des dates au chargement
    document.addEventListener('DOMContentLoaded', function() {
        const dateDebut = document.getElementById('date_debut');
        if (dateDebut.value) {
            document.getElementById('date_fin').min = dateDebut.value;
        }
    });
</script>
@endsection
